...
import '../bexai/components/img.css';
...
class Quizz1 extends Component {
  ...
  render() {
    return (
      <div> <div className="card text-white bg-secondary mb-3"> <div className="App">  <img src={logo} className="App-logo" alt="logo" /> 
      
  </div> <div className="container">
  <div className="card text-white bg-secondary mb-3">
  <div className="hero-body">
    <h1 className="card-title">Quizz En 5 Question</h1>
